...
\definecolor{attributekeywords}{rgb}{0.25,0.68,0.61}
...
\usepackage{listings}
  \lstset{language=[Sharp]C,
    ...
    morekeywords={partial, var, value, get, set, async},
    otherkeywords={[Fact], [Theory], InlineData}, % etc...
    keywordstyle=\color{objects},
